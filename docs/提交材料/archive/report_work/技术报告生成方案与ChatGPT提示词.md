...
| `docs/方案/技术说明文档.md`            | 3.2–3.4 素材 | ⚠️ 停在 8 月规划版 | 报告定稿后 **回写 v2.0「已实现」**，删 IMU/BLE 等未做项或标「规划」 |
...
| `docs/硬件/开发板冒烟测试表单.md`              | 3.5 测试环境   | ❌ 未填         | **郑子轩** 真机测完勾选 A1/A2/A5                     |
...
### 1.1 问题与场景
- 城市步行时，侧后方自行车（含共享单车）及静音电动车接近，行人难察觉。
